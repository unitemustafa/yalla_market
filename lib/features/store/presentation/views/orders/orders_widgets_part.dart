...
class _DeliveryQuoteApprovalCard extends StatefulWidget {
  const _DeliveryQuoteApprovalCard({
  ...
  @override
  State<_DeliveryQuoteApprovalCard> createState() =>
      _DeliveryQuoteApprovalCardState();
}

class _DeliveryQuoteApprovalCardState
    extends State<_DeliveryQuoteApprovalCard> {
