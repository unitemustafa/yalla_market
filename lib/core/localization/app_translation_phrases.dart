...
const Map<String, Map<String, String>> _translationPhrases = {
  'ar': {
    ...
    'Store added to favorites': 'اتضاف المحل للمفضلة',
    'Store removed from favorites': 'اتشال المحل من المفضلة',
    ...
    'Additional instructions (optional)': 'إرشادات إضافية (اختياري)',
    'Address label (optional)': 'تسمية العنوان (اختياري)',
    'Family home': 'منزل العائلة',
    ...
    'Direct area delivery': 'توصيل مباشر داخل المنطقة',
    'External shipping - price later': 'شحن خارجي - السعر يحدد لاحقًا',
