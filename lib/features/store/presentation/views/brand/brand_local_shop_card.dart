...
import '../../../domain/entities/market_shop_data.dart';

class LocalShopCard extends StatelessWidget {
  const LocalShopCard({super.key, required this.shop, required this.onTap});
