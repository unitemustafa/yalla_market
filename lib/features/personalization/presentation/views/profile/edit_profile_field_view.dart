  ...
  bool get _hasChanges {
    ...
    return switch (widget.field) {
      ...
      EditableProfileField.birthDate =>
        _formatDate(_selectedDate) != _initialFieldValue.trim(),
    };
  }
  ...
  Widget _buildInput(bool isDark) {
    if (widget.field == EditableProfileField.gender) {
      ...
      return FormField<String>(
        initialValue: options.any((option) => option.value == _controller.text)
            ? _controller.text
            : null,
        validator: (value) =>
  ...
  Future<void> _save() async {
    ...
    if (!_hasChanges) {
      CustomSnackBar.showWarning(
        context: context,
        title: widget.field == EditableProfileField.phone
